...
import { getAdminProductInputSchema } from "@/features/admin/product/schemas/get-admin-product.schema.ts";
...
export const useGetAdminProduct = (id: AdminProduct["id"]) => {
	const product = useAppSelector(adminProductSelectors.getSelectedProduct);
