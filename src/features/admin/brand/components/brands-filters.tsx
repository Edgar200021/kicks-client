...
import { categoryActions } from "@/features/admin/category/store/category-slice.ts";

interface Props {
	className?: string;
	initialFilters?: GetAllBrandsInput;
}

export const BrandsFilters = ({ className, initialFilters }: Props) => {
	const filters = useAppSelector(brandSelectors.getFilters);
	const lazyFilters = useAppSelector(brandSelectors.getLazyFilters);
	...
	const handleReset = useCallback(() => {
		dispatch(brandActions.clearFilters("lazy"));
		dispatch(brandActions.clearFilters("regular"));
